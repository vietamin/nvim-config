return  {
    ...
    -- mason nvim dap utilizes mason to auttomatically ensure debug adapters you want installed are installed, mason-lspconfig will not automatically install debug adapters for us
    {
    ...
    },
    {
        ...
        config = function()
            ...
            -- Set a vim motion for <Space> + c + <Shift>R to smartly rename the code under the cursor (like in intelliJ)
