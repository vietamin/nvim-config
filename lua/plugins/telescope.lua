return {
    ...
    tag = '0.1.6',
    dependencies = {
        -- general purpose pluginn used to build user interfaces in neovim plugins
    ...
    config = function()
        ...
        -- set a vim motion to <Space> + f + d to search for Code Diagnostics in the current prject
